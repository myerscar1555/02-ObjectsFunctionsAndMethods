...
#    even_better_draw_circles(rg.Point(100, 50), 15, 11, 'blue', 5)
#    even_better_draw_circles(rg.Point(-200, 0), 10, 25, 'red', 1)
    even_better_draw_circles(rg.Point(0, 0), 5, 40, 'blue', 3)
    even_better_draw_circles(rg.Point(0, 0), 12, 17, 'red', 5)
    even_better_draw_circles(rg.Point(0, 0), 7, 30, 'black', 7)
